...
// src/components/TerminalEmuCard.tsx
...
function TerminalEmuCard() {
  ...
  const [histIndex, setHistIndex] = (0, import_react.useState)(null);
  const [theme, setTheme] = (0, import_react.useState)("matrix");
  const [cmdlist, setCmdList] = (0, import_react.useState)([]);
  const outRef = (0, import_react.useRef)(null);
  const inRef = (0, import_react.useRef)(null);
  const engineRef = (0, import_react.useRef)(null);
  const prompt = (0, import_react.useMemo)(() => "guest@portfolio:~$", []);
  const themeClasses = (0, import_react.useMemo)(() => {
    switch (theme) {
      case "light":
  ...
  (0, import_react.useEffect)(() => {
    ...
    (async () => {
      ...
      setCmdList(Array.isArray(list) ? list : []);
    })();
    return () => {
      mounted = false;
    };
  ...
  const run = async (raw) => {
    ...
    try {
      const actions = engine.handle_command(trimmed);
  ...
  const onKeyDown = (e) => {
    if (e.key === "Enter") {
      ...
      setHistIndex(null);
      run(val).catch((e2) => setLines((prev) => [...prev, { kind: "out", text: String(e2) }]));
      return;
    }
    if (e.key === "ArrowUp") {
      e.preventDefault();
...
document.querySelectorAll(".js-terminal-emu").forEach((el) => {
  (0, import_client.createRoot)(el).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TerminalEmuCard, {}));
});
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=terminal-emu.js.map